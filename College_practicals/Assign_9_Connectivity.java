...
import java.util.*;  
 ...
 case 7:
 	...
 	System.out.println("Enter new column name  modify");
 	/* Give the name of above column added to table*/
 	String deven=sc.nextLine();
   
 	//String sql2= " ALTER TABLE "+ table1 + " modify " + colnm1 + " VARCHAR(50)";
 	String sql2= " ALTER TABLE "+ table1 + " RENAME COLUMN " + colnm1 + " to " + deven;
 	s=con.createStatement();
 ...
 flag=true;  
 if(str.equals("no")||str.equals("n")) System.exit(1);
 flag=false;  
